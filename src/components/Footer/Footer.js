...
function Footer() {
  return (
        <footer className="footer">
            <div className="footer__title">Training project Y.Practicum x BeatFilm.</div>
            <div className="footer__links">
            <p className="footer__copyright"> &copy; {new Date().getFullYear()}</p>
                <nav className="menu menu_type_mobile">
                    <a href="https://practicum.yandex.ru/" className="footer__link" target="_self">Yandex.Practicum</a>
